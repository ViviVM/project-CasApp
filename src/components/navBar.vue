    ...
    <div class="container-fluid">
      <a class="navbar-brand h1 mb-0" href="/">
        <svg
          ...
          height="35"
          fill="currentColor"
          class="bi bi-triangle-half align-text-top d-inline-block"
          viewBox="0 0 16 16"
        >
          <path
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item" v-if="userStore.user === null">
            <a
              class="nav-link active text-user"
              aria-current="page"
              href="/login"
              >Log In</a
            >
          ...
          <li class="nav-item dropdown" v-if="userStore.user !== null">
            <a
              class="nav-link dropdown-toggle text-user"
              href="#"
              role="button"
