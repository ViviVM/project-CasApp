  ...
  <div class="container">
    ...
    <div class="row g-0">
      <div class="col-sm-4 col-left position-relative">
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="150" fill="currentColor" class="bi bi-triangle-half position-absolute top-50 start-50 translate-middl" viewBox="0 0 16 16">
        ...
        <div class="card-body">
          ...
          <form class="form-signin">  
            <div class="mb-3">
              ...
              <input type="text" class="form-control " id="inputText1" placeholder="Your full name" required autofocus>
            </div>
